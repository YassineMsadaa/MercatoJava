...
public class AcceuilUserController implements Initializable {
    ...
    public static final int loggedUser=1;
        ...
        paneMarketplace.setOnMouseClicked(new EventHandler<MouseEvent>() {
            ...
            public void handle(MouseEvent event) {
                ...
                try {
                 ...
                 if (SponsorService.sponsorService.isSponsoredUser(u) ){
            ...
            public void handle(MouseEvent event) {
                ...
                try {
                 ...
                 if (SponsorService.sponsorService.isSponsoredUser(u) ){
                    ...
                    Logger.getLogger("AcceuilUserController.java").log(Level.SEVERE, null, ex);
                }
            }
        });
        ...
        buttonAccederMonProfil.setOnMouseClicked(new EventHandler<MouseEvent>() {
            ...
            public void handle(MouseEvent event) {
                ...
                try {
                    ...
                    Logger.getLogger("MonProfilController.java").log(Level.SEVERE, null, ex);
                }
            }
        });
    }
