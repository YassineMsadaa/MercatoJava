...
public class MarketplaceControler implements Initializable {
    ...
    @FXML
    public static Tab TabMarketPlace;
    @FXML
    private ListView<Product> ListViewProduit;
    @FXML
    public static Tab TabMesProduit;
    @FXML
    private ListView<Product> ListViewMesProduit;
    @FXML
    public static Tab TabProduitAjout;
    @FXML
    ...
    private ObservableList<Product> data2;
    @FXML
                    ...
                    ListCell<Product> cell = new ListCell<Product>() {
                        ...
                        protected void updateItem(Product p, boolean bln) {
                            ...
                            if (p != null) {
                                ...
                                btnSupprimer.setOnAction(new EventHandler<ActionEvent>() {
                                    ...
                                    public void handle(ActionEvent e) {
                                        ...
                                        try {
                                            ...
                                            data2.addAll(myproducts);
                                            ListViewMesProduit.setItems(data2);
                                            afficherMesProducts();
                                        } catch (Exception ex) {
                                            Logger.getLogger(MarketplaceControler.class.getName()).log(Level.SEVERE, null, ex);
                                        }
                                ...
                                Label dateDepotText = new Label("Date de depot : " + p.getDate().toString());
...
///////////////////////////////////////////////////////////////////////////////////////////////:////////////////////////::
    ...
    public void initialize(URL url, ResourceBundle rb) {
        System.out.println("sd" + tabselected);
        if (tabselected == 2) {

            System.out.println(tabselected);
            tabToutsLesProjet.getSelectionModel().select(TabMesProduit);

        }

        int idLogUser;
        idLogUser = AcceuilUserController.loggedUser;
        System.out.println("aaaaaaaaaaaaaaa" + AcceuilUserController.loggedUser);
        sp = sps.FindByUser(AcceuilUserController.loggedUser);
...
//***********************************************btn addproduct****************************************************************
        buttonAddProduct.setOnMouseClicked(new EventHandler<MouseEvent>() {
            ...
            public void handle(MouseEvent event) {
                ...
                try {
                    Stage stage = new Stage();
                    Stage stageprev = (Stage) buttonAddProduct.getScene().getWindow();
...
//*******************************************************rechercher***************************************************************
        recherchebar1.textProperty().addListener(new ChangeListener<String>() {
            @Override
            public void changed(final ObservableValue<? extends String> observable, final String oldValue, final String newValue) {
                ...
                if (recherchebar1.getText().isEmpty()) {
                    ...
                    products = mps.ListAll();
                    products = h.rechercheProductByNom(products, recherchebar1.getText().toLowerCase().trim());
                    data = FXCollections.observableArrayList();
                    data.addAll(products);
                    ListViewProduit.setItems(data);
                    afficherProducts();
        ...
        recherchebar11.textProperty().addListener(new ChangeListener<String>() {
            @Override
            public void changed(final ObservableValue<? extends String> observable, final String oldValue, final String newValue) {
                // this will run whenever text is changed
                System.out.println(observable.toString());
                ...
                if (recherchebar11.getText().isEmpty()) {
                    ...
                    //myproducts=h.rechercheMyProduct(myproducts, AcceuilUserController.loggedUser);
                    ...
                    myproducts = mps.ListAll();
                    myproducts = h.rechercheMyProduct(myproducts, AcceuilUserController.loggedUser);
                    myproducts = h.rechercheProductByNom(myproducts, recherchebar11.getText().toLowerCase().trim());
                    data2 = FXCollections.observableArrayList();
                    data2.addAll(myproducts);
                    ListViewMesProduit.setItems(data2);
                    afficherMesProducts();
    ...
    private void TrierDateDecAction1(ActionEvent event) {
        ...
        MarketPlaceService mps = new MarketPlaceService();
        products = mps.ListAll();
        products.sort(new ProductDateComaprable().reversed());
        data = FXCollections.observableArrayList();
        data.addAll(products);
        ListViewProduit.setItems(data);
        afficherProducts();
    ...
    private void dateTrierCrAction1(ActionEvent event) {
        ...
        MarketPlaceService mps = new MarketPlaceService();
        products = mps.ListAll();
        products.sort(new ProductDateComaprable());
        data = FXCollections.observableArrayList();
        data.addAll(products);
        ListViewProduit.setItems(data);
        afficherProducts();
    ...
    private void prixTrierDecAction1(ActionEvent event) {
        ...
        MarketPlaceService mps = new MarketPlaceService();
        products = mps.ListAll();
        products.sort(new ProductPriceComparator().reversed());
        data = FXCollections.observableArrayList();
        data.addAll(products);
        ListViewProduit.setItems(data);
        afficherProducts();
    ...
    private void TrierDateDecAction11(ActionEvent event) {
        ...
        MarketPlaceService mps = new MarketPlaceService();
        products = mps.getBySponsoredUser(sp);
        products.sort(new ProductDateComaprable().reversed());
        data = FXCollections.observableArrayList();
        data.addAll(products);
        ListViewProduit.setItems(data);
